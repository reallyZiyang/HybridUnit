...
namespace Game.Play.Editor.Extensions
{
    ...
    {
        public static string ExecuteBat(string workingPath, string fileName)
        {
        ...
        public static string ExecuteShellCommand(string command, string arguments)
        {
        ...
        public static async Task<ProcessResult> ExecuteShellCommandAsync(string command, string arguments, int timeout)
        {
            ...
            using (var process = new Process())
            {
                ...
                if (isStarted)
                {
                    ...
                    if (await Task.WhenAny(Task.Delay(timeout), processTask) == processTask && waitForExit.Result)
                    {
                        ...
                        UnityEngine.Debug.Log(outputBuilder);
                    }
                    else
                    {
                        try
